...
//constructor : varaible initialisation
Image::Image(void)
{ 
    width = 0; 
    height = 0; 
...
int Image::GetWitdth(void) const
{
  return width;
}
...
void Image::ppm_write_to_file(char* filename) 
{
  // Write the desaturated image into <file>
...
void Image::ppm_shrink(int factor) //(u_char** image, int *width, int *height, int factor)
{
